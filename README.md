...
3) Download the latest version of Terraform. This repo was designed on v1.1.9, in case you run into incompatibilities with newer versions.
...
- [ec2-user@]$ cat render-content.txt 
  a
  a) The presence of the ‘a' in the contents of the file shows that the agent was able to use the approle role ‘my-role’ and grab the contents of Data.data.foo from the secret ‘my-secret’